<script lang="ts">
        ...
        const editChatTitle = async (id, title) => {
                if (title === '') {
                        ...
                        await updateChatById('static-token', id, {
                                title: title
                        });
        ...
        const generateTitleHandler = async () => {
                ...
                const generatedTitle = await generateTitle('static-token', model, messages).catch(
                        (error) => {
                                toast.error(`${error}`);
                                return null;
                        }
                ...
                {:else if shiftKey && mouseOver}
                        <div class=" flex items-center self-center space-x-1.5">
                                        ...
                                        <button
                                                ...
                                                type="button"
                                        >
                                                <Icon name="ArchiveBox" className="size-4  translate-y-[0.5px]" strokeWidth="2" />
                                        </button>
                                        ...
                                        <button
                                                ...
                                                type="button"
                                        >
                                                <Icon name="GarbageBin" strokeWidth="2" />
                                        </button>
