<script lang="ts">
        ...
        const exportTableToCSVHandler = (token, tokenIdx = 0) => {
                ...
                { const url = URL.createObjectURL(blob); const a = document.createElement("a"); a.href = url; a.download = `table-${id}-${tokenIdx}.csv`; a.click(); URL.revokeObjectURL(url); };
        };
</script>
        ...
        {:else if token.type === 'table'}
                <div class="relative w-full group mb-2">
                        ...
                        <div class=" absolute top-1 right-1.5 z-20 invisible group-hover:visible flex gap-0.5">
                                        ...
                                        >
                                                <Icon name="Clipboard" className=" size-3.5" strokeWidth="1.5" />
                                        </button>
